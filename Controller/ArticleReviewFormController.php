...
class ArticleReviewFormController extends Controller
{
    ...
    public function reviewFormsAction($dialogId)
    {
        ...
        return $this->render('VipaWorkflowBundle:DialogPost/review_form:_browse_review_forms.html.twig', [
            'forms' => $forms,
            'dialogId' => $dialogId,
        ]);
    }
    ...
    {
        return $this->render('VipaWorkflowBundle:DialogPost/review_form:_show.html.twig', [
    ...
    public function previewReviewFormResponseAction($postId)
    {
        ...
        return $this->render('VipaWorkflowBundle:DialogPost/review_form:_response_preview.html.twig', [
            'post' => $responsePost,
    ...
    public function submitFormAction(Request $request, StepReviewForm $reviewForm, $dialogId)
    {
        ...
        return $this->render('VipaWorkflowBundle:DialogPost/review_form:_submit_form.html.twig', [
            'reviewForm' => $reviewForm,
            'dialogId' => $dialogId,
        ]);
    }
    ...
    public function reviewFormResponsesAction($dialogId)
    {
        ...
        return $this->render('VipaWorkflowBundle:DialogPost/review_form:_browse_review_form_responses.html.twig', [
